...
Begin
  try
     try
       fr_pumpt_spr:=Tfr_pumpt_spr.Create(Application);
       fr_pumpt_spr.ShowModal;
     finally
       fr_pumpt_spr.Free;
     end
  except
...
procedure Tfr_pumpt_spr.bt_exitClick(Sender: TObject);
begin
  Close;
end;

procedure Tfr_pumpt_spr.FormCreate(Sender: TObject);
begin
   OpenSPR;
end;

procedure Tfr_pumpt_spr.OpenSPR;
var
 res, par : variant;
Begin
...
procedure Tfr_pumpt_spr.cds_pump_typeAfterOpen(DataSet: TDataSet);
begin
...
procedure Tfr_pumpt_spr.cds_pump_typeAfterClose(DataSet: TDataSet);
begin
...
procedure Tfr_pumpt_spr.bt_delClick(Sender: TObject);
var
  res, par : variant;
begin
...
procedure Tfr_pumpt_spr.bt_addClick(Sender: TObject);
var
  ss : string;
  res, par : variant;
  w_count, tid : integer;
...
procedure Tfr_pumpt_spr.bt_editClick(Sender: TObject);
var
  ss : string;
  res, par : variant;
  w_count : integer;
